...
public class User {
    ...
    public User(String nome, String email, Integer idade, String rua, String numero, String bairro, String cidade, String uf, String cep) {
    ...
    public User(String nome, String email, Integer idade, Endereco endereco) {
